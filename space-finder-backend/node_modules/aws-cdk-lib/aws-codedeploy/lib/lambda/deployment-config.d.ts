...
export declare class LambdaDeploymentConfig extends BaseDeploymentConfig implements ILambdaDeploymentConfig {
    ...
    static readonly ALL_AT_ONCE: IBaseDeploymentConfig;
    ...
    static readonly CANARY_10PERCENT_30MINUTES: IBaseDeploymentConfig;
    ...
    static readonly CANARY_10PERCENT_5MINUTES: IBaseDeploymentConfig;
    ...
    static readonly CANARY_10PERCENT_10MINUTES: IBaseDeploymentConfig;
    ...
    static readonly CANARY_10PERCENT_15MINUTES: IBaseDeploymentConfig;
    ...
    static readonly LINEAR_10PERCENT_EVERY_10MINUTES: IBaseDeploymentConfig;
    ...
    static readonly LINEAR_10PERCENT_EVERY_1MINUTE: IBaseDeploymentConfig;
    ...
    static readonly LINEAR_10PERCENT_EVERY_2MINUTES: IBaseDeploymentConfig;
    ...
    static readonly LINEAR_10PERCENT_EVERY_3MINUTES: IBaseDeploymentConfig;
    /**
